                                  ...
                                  <div class="card text-center justify-content-center shaodw-lg  card-1 border-0 bg-white px-sm-2">
                                      <div class="card-body show  ">
                                          ...
                                          <div class="radio-group row justify-content-between px-3 text-center a">
                                                  ...
                                                  <div class="flex-row">
                                                      <div class="col">
                                                          <div class="pic">
                                                              ...
                                                              <strong>JOAN DELA CRUZ</strong><br>
                                                              <strong>0934-0980-3132</strong> <br>
                                                              <i>123R 2F Wallstreet</i><br>
                                              ...
                                              <div class="col-auto ml-sm-2 mx-1 card-block  py-0 text-center radio  ">
                                                  <div class="flex-row">
                                                      <div class="col">
                                                          <div class="pic"> 
                                                              <strong>JOANA DELA CRUZ</strong><br>
                                                              <strong>0934-0980-3131</strong> <br>
                                                              <i>123R 3F Wallstreet</i><br>
                                                              <i>San Firnando, Califonia</i><br>
                                                          </div>
                                                          <p>Address 2</p>
                                                      </div>
                                          ...
                                          <div class="row justify-content-center">
                                              <div class="col">
                                                  <p class="text-muted">Select the address where you want us to deliver your parcel.</p>
                                              </div>
                                          </div>
