...
db_connection = mysql.connector.connect(host="localhost",user="root",passwd="",database="paypal_payment")
...
def generate_models(table):
	line = ""
	line += "\n<?php"
	line += "\nClass model_table_name extends CI_Model{"
	line += "\n"
	...
	with open('./application/models/model_'+table+'.php', 'w') as f:
	    f.write(line)
